...
We apply more than 100 practices and optimizations, you can opt in or out for most of these features using our CLI flags. Following are a few examples of features, to learn about the full list of features, [please visit here](https://practicajs.org/features)
...
Practica is a community-driven open-source project. It's being led voluntarily by engineers from many companies. On top of this, these companies below which are keen on great engineering practices chose to let their engineers contribute massively and push this project firmly 💚
...
These companies are keen on continuous improvements and encouraging their engineers to contribute during work hours
