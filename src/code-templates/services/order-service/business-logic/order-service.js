...
var AppError = require("../../../libraries/error-handling/error-handling").AppError;
var MessageQueueClient = require("../../../libraries/message-queue-client/message-queue-client").default;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axiosHTTPClient.get("http://localhost/user/" + userId, {
                            timeout: 2000,
