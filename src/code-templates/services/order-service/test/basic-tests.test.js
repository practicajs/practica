...
describe("/api", () => {
  describe("GET /order", () => {
    test("When asked for an existing order, Then should retrieve it and receive 200 response", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        //Arrange
        const orderToAdd = {
          userId: 1,
        ...
        } = yield axiosAPIClient.post(`/order`, orderToAdd);
        //Act
    ...
    test("When asked for an non-existing order, Then should receive 404 response", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        //Arrange
        const nonExistingOrderId = -1;
        //Act
        const getResponse = yield axiosAPIClient.get(
  ...
  describe("POST /orders", () => {
    ...
    test("When adding a new valid order, Then should get back approval with 200 response", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        //Arrange
        const orderToAdd = {
          userId: 1,
        ...
        //Act
        const receivedAPIResponse = yield axiosAPIClient.post(
          "/order",
          orderToAdd
        );
        //Assert
    ...
    test("When adding a new valid order, Then should be able to retrieve it", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        //Arrange
        const orderToAdd = {
          userId: 1,
        ...
        //Assert
        const { data, status } = yield axiosAPIClient.get(
          `/order/${addedOrderId}`
        );
        expect({
          data,
    ...
    test("When adding an order without specifying product, stop and return 400", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        //Arrange
        const orderToAdd = {
          userId: 1,
    ...
    test("When the user does not exist, return 404 response", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        //Arrange
