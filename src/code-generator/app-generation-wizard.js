...
var QuestionsWizard = function () {
    ...
    var logoPath = path.join(__dirname, "./practica-logo.png");
    terminalImage.file(logoPath, { width: 70, preserveAspectRatio: true }).then(function (image) { return stdout.write(image); });
