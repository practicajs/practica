...
describe("generateApp", function () {
    test("When destination does not exist, then the destination folder created and includes content ", function () { return __awaiter(void 0, void 0, void 0, function () {
        var options, destinationFolderContent;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
