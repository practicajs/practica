...
var dockerCompose = require("docker-compose");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, isPortReachable(54310)];
            case 1:
                isDBReachable = _a.sent();
                if (!!isDBReachable) return [3 /*break*/, 4];
                // ️️️✅ Best Practice: Start the infrastructure within a test hook - No failures occur because the DB is down
                return [4 /*yield*/, dockerCompose.upAll({
            ...
            case 2:
                // ️️️✅ Best Practice: Start the infrastructure within a test hook - No failures occur because the DB is down
                _a.sent();
                return [4 /*yield*/, dockerCompose.exec("database", ["sh", "-c", "until pg_isready ; do sleep 1; done"], {
                        cwd: path.join(__dirname),
                    })];
            case 3:
                _a.sent();
