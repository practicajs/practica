...
var MessageQueueStarter = /** @class */ (function () {
    ...
    MessageQueueStarter.prototype.start = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.consumeUserDeletionQueue()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    MessageQueueStarter.prototype.consumeUserDeletionQueue = function () {
        return __awaiter(this, void 0, void 0, function () {
            var deletedOrderMessageHandler;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        deletedOrderMessageHandler = function (message) { return __awaiter(_this, void 0, void 0, function () {
                            var newMessageAsObject, orderRepository;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
